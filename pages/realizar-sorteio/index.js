...
export default function Index() {
  ...
  async function cadastrarBilhetePremiado(dados, num){
  ...
  async function buscarJogador(num){
    ...
    cadastrarBilhetePremiado(te, num)
  ...
  function hideTelefone(tel){
    var newArray = tel.split('-')
    console.log('Novo numero ', newArray[0], newArray[1])
    return newArray[0] + ' - ' + 'XXXX'
  }
                            ...
                            <Col md={4}>
                              <div className={'colBlocoSorteio'}>
                                <div>
                                  ...
                                  <p>Telefone do ganhador: <strong>{hideTelefone(listaGanhador.telefone)}</strong></p>
