...
import { getFirestore, doc, setDoc, query, collection, getDocs } from "firebase/firestore";
...
export default function Index() {
  ...
  function gerarBilhete(){
    ...
    for (let b = 0; b < qto; b++) {
      ...
      // console.log("Gerou 5", arrayNumerosBilhetes)
      arrayBilhetes.push(
        {
          'numero' : inicial, 
          'sorteio': watch("numerosorteio"),
        ...
        <Container className={styles.container} fluid>
            <Container>
                ...
                <Row id="text2" style={{marginLeft: 0, width: 900}} ref={ref}>
                    ...
                    <MovieList bilhetes={bilhetes} numerosorteio={watch("numerosorteio")} qtobilhete={watch("qtobilhete")}/>
