...
export default function MovieList({bilhetes, qtobilhete}) {
  console.log('=====> ', bilhetes, qtobilhete)
  ...
  const fetchMovie = e => {
    ...
    var primeiroPag = bilhetes[0];
    var qto = parseInt(qtobilhete)
    var utimaPag = bilhetes[qto - 1]
    console.log('dsadasdasdasd', primeiroPag.numero, utimaPag.numero)
    setNomeFile(primeiroPag.numero+'-a-'+utimaPag.numero)
